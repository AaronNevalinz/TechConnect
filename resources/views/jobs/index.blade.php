                ...
                <div class="flex-grow">
                    <div class="flex flex-col sm:flex-row justify-between">
                        <div>
                            ...
                            <p class="text-blue-500 mt-1 text-sm sm:text-base">{{ Str::limit($job->description, 100) }}</p>
                            <p class="text-gray-600 mt-1 text-sm sm:text-base">{{ $job->location }}</p>
                            <p class="text-gray-600 mt-1 text-sm sm:text-base">{{ $job->salary_range }}</p>
                            <div class="flex flex-wrap gap-2 mt-2 text-xs">
                                <span class="text-gray-600">Customer Service</span>
                                <span class="text-gray-400 hidden sm:inline">•</span>
                                <span class="text-gray-600">Logistics</span>
                                <span class="text-gray-400 hidden sm:inline">•</span>
                                <span class="text-gray-600">{{ ucfirst($job->status) }}</span>
                            </div>
                        </div>
