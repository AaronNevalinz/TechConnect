        ...
        <div class="-mx-4 flex flex-wrap">
          <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
            <div class="mb-10 w-full">
              ...
              >
              <span class="mb-9 text-lg font-bold text-white ">TechConnect</span>
                {{-- <img
                ...
                <img
                  ...
                  alt="logo"
                  class="hidden max-w-full block"
                /> --}}
              </a>
              <p class="mb-7 text-base text-body-color text-white">
                Sed ut perspiciatis undmnis is iste natus error sit amet
                voluptatem totam rem aperiam.
              </p>
              <p
                class="flex items-center text-sm font-medium text-white text-white"
              >
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-2/12">
            <div class="mb-10 w-full">
              <h4 class="mb-9 text-lg font-semibold text-white text-white">
                Resources
              </h4>
              <ul class="space-y-3">
                <li>
                  <a
                    href="javascript:void(0)"
                    class="inline-block text-base leading-loose text-body-color hover:text-primary text-white"
                  >
                    SaaS Development
                  </a>
                </li>
          ...
          <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div class="mb-10 w-full">
              ...
              <div class="mb-6 flex items-center">
                <a
                  href="javascript:void(0)"
                  class="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-stroke text-white hover:border-primary hover:bg-primary hover:text-white sm:mr-4 lg:mr-3 xl:mr-4 border-dark-3 text-white hover:border-primary"
                >
                  <svg
                    width="8"
                    height="16"
